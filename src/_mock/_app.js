...
export const _appCourseLikes = [...Array(6)].map((_, index) => ({
  id: _mock.id(index),
  course: ['Course 1', 'Course 2', 'Course 3', 'Course 4', 'Course 5', 'Course 6'][index],
  branch: _mock.branch(index),
  targetGroup: _mock.targetAudience(index),
  likes: [500, 400, 300, 200, 100, 50][index]
}));

export const _appQuality = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  branch: _mock.branch(index),
  targetGroup: _mock.targetAudience(index),
  quality: [500, 400, 300, 200, 100, 50][index]
}));
